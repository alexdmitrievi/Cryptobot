...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        "🚀 *ТВХ — твоя точка входа* в трейдинг и инвестиции!\n\n"
        "Всего за 30 секунд ты получаешь:\n"
        "• 📍 Подсказку где войти и где выйти из сделки\n"
        "• 📊 Разбор графика простым языком\n"
        "• 💡 План покупок для долгосрока с целями\n"
        "• 📰 Объяснение важных новостей и их влияние на рынок\n"
        "• 🌍 Все рынки: Крипта, Forex и акции (MOEX)\n"
        "• 🧘 GPT-психолог для дисциплины и спокойствия\n\n"
        "👉 Нажми кнопку ниже и попробуй прямо сейчас ⤵️"
    )
