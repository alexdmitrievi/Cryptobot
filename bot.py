...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if selected_style == "smc":
        prompt_text = (
            ...
            "3. Дай чёткий план сделки в формате:\n"
            "📈 Setup:\n"
            "- Entry: $_____\n"
            "- StopLoss: $_____\n"
            "- TakeProfit: $_____\n\n"
            "Объясни почему именно здесь вход, что делает толпа и как заходят институционалы."
        )
    elif selected_style == "swing":
        prompt_text = (
            "Ты — трейдер позиционного swing типа с 10+ лет на крипте, форексе и MOEX.\n\n"
            "На изображении график. Найди:\n"
            "1. Ключевые уровни поддержки и сопротивления.\n"
            "2. Зоны накоплений маркетмейкеров.\n"
            "3. Дай план сделки в таком формате:\n"
            "📈 Setup:\n"
            "- Entry: $_____\n"
            "- StopLoss: $_____\n"
            "- TakeProfit: $_____\n\n"
            "Объясни, почему эти уровни выбраны и какие альтернативные сценарии (пробой/отбой)."
        )
    elif selected_style == "breakout":
        prompt_text = (
            "Ты — скальпер и интрадей трейдер с 10+ лет на крипте, форексе и MOEX.\n\n"
            "На изображении график. Найди:\n"
            "1. Диапазон (консолидацию), где возможен пробой.\n"
            "2. Сценарий пробоя вверх и пробоя вниз.\n"
            "3. Для каждого дай план сделки в формате:\n"
            "📈 Breakout вверх:\n"
            "- Entry: $_____\n"
            "- StopLoss: $_____\n"
            "- TakeProfit: $_____\n\n"
            ...
            "- StopLoss: $_____\n"
            "- TakeProfit: $_____\n\n"
            "Объясни, почему тут может быть пробой и какие подтверждающие сигналы лучше всего отследить."
        )
    else:
        prompt_text = (
            "Ты — трейдер с опытом более 10 лет.\n"
            "На изображении график. Определи тренд, ключевые уровни, риски и дай краткий план сделки в формате:\n"
            "📈 Setup:\n"
            "- Entry: $_____\n"
            "- StopLoss: $_____\n"
            "- TakeProfit: $_____\n\n"
            "Объясни кратко почему вход именно здесь."
        )
