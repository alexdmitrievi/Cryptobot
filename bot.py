...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        "За 30 секунд бот даст:\n"
        "• 📍 Где войти и где выйти из сделки\n"
        "• 📊 Разбор графика простым языком\n"
        "• 💡 План покупок для долгосрока\n"
        "• 📰 Пояснение важных новостей\n"
        "• 🧘 Поддержку дисциплины от GPT‑психолога\n\n"
        "👉 Выбирай действие на клавиатуре ниже ⤵️"
    )
