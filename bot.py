...
# Определим путь относительно bot.py
...
async def publish_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        "💰 Доходность на крипте кратно выше:\n"
        ...
        "🎁 Подключись сейчас и получи бонус:\n"
        "📚 Полный курс по скальпингу и позиционке (10+ уроков и PDF-гайды).\n\n"
