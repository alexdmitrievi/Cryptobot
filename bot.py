...
async def publish_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        "🚀 *GPT-Трейдер для Telegram* — твой личный аналитик, VIP-сигналы и психолог в одном боте.\n\n"
        "🔍 Что даёт:\n"
        "• 📈 Автоматические прогнозы по скринам за 10 секунд\n"
        "• 📰 Интерпретации макро-новостей с готовыми сценариями\n"
        "• 🎯 VIP-сигналы прямо в Telegram с обновлениями по ходу сделки (БУ, фиксация, force majeure)\n"
        "• 🧘 GPT-психолог: мемы и поддержка после минусов\n\n"
        "💡 Работает 24/7 без подписок на ChatGPT, VPN и сложных настроек.\n"
        "💬 Уже *500+ трейдеров* подключились и ежедневно используют бота.\n\n"
        "🎁 *+ Бонус для новых подписчиков:*\n"
        "📚 Полный обучающий курс по скальпингу и позиционке\n"
        "• Более 10 видеоуроков и PDF-гайдов\n"
        "• Настройка психологии, точки входа и выхода\n"
        "• Готовые схемы даже для начинающих\n\n"
        "🚀 *Доступ навсегда всего за $25 (~3.4 TON)*\n"
        "📊 Получай сигналы, аналитику и торговые планы в любое время.\n\n"
